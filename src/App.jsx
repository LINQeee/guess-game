...
const WORD_BANKS = {
  ...
  4: [
    ...
    "Фортнайт", "Симс", "Call of Duty", "Киберпанк", "Одни из нас", "Ведьмак 3", "Скайрим", "Портал", "Тетрис", "Мортал Комбат"
  ],
  5: [
    ...
    "Чёрное зеркало", "Ход королевы", "Бумажный дом", "Во все тяжкие", "Острые козырьки", "Локи", "ВандаВижен", "Академия Амбрелла", "Мир Дикого Запада", "Офис",
    "Волк с Уолл-стрит", "Достать ножи", "Ла-Ла Ленд", "Дюна", "Гравити Фолз", "Рик и Морти", "Атака титанов", "Тетрадь смерти", "Человек-бензопила", "Аркейн",
    "Зельда", "Хогвартс", "Элли", "Джоэл", "Лара Крофт", "Кратос", "Мастер Чиф", "Гордон Фримен", "Си-Джей", "Солид Снейк"
  ],
  6: [
    "парадокс", "абстракция", "метафора", "концепция", "феномен", "идентичность", "манипуляция", "синергия", "интерпретация", "двусмысленность",
    "самореализация", "противоречие", "стереотип", "рефлексия", "аллегория", "катарсис", "дилемма", "амбиция", "авторитет", "рациональность",
    "хаос", "утопия", "драматургия", "кульминация", "субъективность", "эволюция", "поколение", "мифология", "деконструкция", "архетип",
    "контекст", "подтекст", "сатира", "пародия", "клише", "канон", "реткон", "антигерой", "мораль", "мотив",
    "реплика", "монтаж", "кадр", "эпизод", "критик", "рейтинг", "номинация", "экранизация", "адаптация", "оригинал",
    "Оскар", "Канны", "Бродвей", "Дисней", "Пиксар", "Студия Гибли", "Хаяо Миядзаки", "Кристофер Нолан", "Квентин Тарантино", "Стэн Ли",
    "Саурон", "Гэндальф", "Тирион Ланнистер", "Дейенерис", "Нео", "Морфеус", "Терминатор", "Рокки", "Индиана Джонс", "Хан Соло",
    "Сайлент Хилл", "Резидент Ивел", "Метал Гир", "Финальная фантазия", "Стардью Вэлли", "Хейдис", "Дарк Соулс", "Элден Ринг", "Дум", "Half-Life"
  ],
  7: [
    'первое свидание',
    'секретный пароль',
    ...
    'удачный момент',
    'большая ошибка',
    'Гарри Поттер и палочка',
    'Шрек и осёл',
    'Бэтмен без маски',
    'Человек-паук в метро',
    'Марио и принцесса',
    'Пикачу в покеболе',
    'Барби в розовом доме',
    'Дарт Вейдер и маска',
    'Джек Воробей на корабле',
    'Губка Боб на работе',
    'Симба на скале',
    'Эльза и ледяной дворец',
    'Майнкрафт без кирки',
    'ГТА и полиция',
    'Among Us и предатель',
    'Соник на скорости',
    'Форсаж без машины',
    'Титаник и айсберг',
    'Рататуй на кухне',
    'Один дома на праздники',
    'Друзья в кофейне',
    'Симпсоны на диване',
    'Матрица и красная таблетка',
    'Звёздные войны в космосе',
    'Властелин колец и кольцо',
    'Пираты Карибского моря и компас',
    'Очень странные дела и монстр',
    'Игра престолов и дракон',
    'Ведьмак и монета',
    'Наруто и повязка',
    'Покемоны и тренер',
    'Фортнайт и танец',
    'Симс без лестницы',
    'Плейстейшен и джойстик',
    'Нетфликс на вечер',
    'Ютуб без рекламы',
    'мем про кота',
    'стрим до утра',
    'косплей на фестивале',
    'спойлер в чате'
  ],
  8: [
    ...
    'чемодан без ручки',
    'работа мечты',
    'зарплата после отпуска',
    'будильник в понедельник',
    'переписка до утра',
    'тишина в библиотеке',
    'мороженое зимой',
    'чай без сахара',
    'супергерой без силы',
    'злодей с добрым сердцем',
    'робот с эмоциями',
    ...
    'Халк в пробке',
    'Тор без молота',
    'Железный человек без костюма',
    'Капитан Америка без щита',
    'Дарт Вейдер без дыхания',
    'Йода говорит наоборот',
    'Мандалорец и малыш',
    'Терминатор в прошлом',
    'Нео выбирает таблетку',
    'Джек Воробей ищет ром',
    'Индиана Джонс и шляпа',
    'Гэндальф не пускает',
    'Саурон и кольцо',
    'Геральт в ванной',
    'Цири в бегах',
    'Танос щёлкает пальцами',
    'Локи снова обманул',
    'Симба вспоминает отца',
    'Эльза отпускает ситуацию',
    'Мулан идёт в армию',
    'Рапунцель спускает волосы',
    'Валли собирает мусор',
    'Грут говорит одно слово',
    'Скуби-Ду боится монстра',
    'Том ловит Джерри',
    'Майнкрафт ночью',
    'Роблокс с друзьями',
    'ГТА без правил',
    'Симс строит дом',
    'Фортнайт после школы',
    'Покемон в траве',
    'Марио спасает принцессу',
    'Соник собирает кольца',
    'Зельда и загадка'
  ]
};
