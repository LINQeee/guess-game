...
const WORD_BANKS = {
  ...
  4: [
    ...
    "Фортнайт", "Симс", "Call of Duty", "Киберпанк", "Скайрим", "Портал", "Тетрис", "Мортал Комбат"
  ],
  5: [
    ...
    "Бумажный дом", "Во все тяжкие", "Острые козырьки", "Локи", "Офис",
    "Волк с Уолл-стрит", "Достать ножи", "Ла-Ла Ленд", "Дюна", "Гравити Фолз", "Рик и Морти", "Атака титанов", "Тетрадь смерти", "Человек-бензопила",
    "Зельда", "Хогвартс", "Лара Крофт", "Кратос", "Мастер Чиф", "Гордон Фримен", "Си-Джей"
  ],
  6: [
    "парадокс", "абстракция", "метафора", "концепция", "феномен", "идентичность", "манипуляция", "синергия", "интерпретация", "двусмысленность",
    "самореализация", "противоречие", "стереотип", "рефлексия", "аллегория", "дилемма", "амбиция", "авторитет", "рациональность",
    "хаос", "утопия", "драматургия", "кульминация", "субъективность", "эволюция", "поколение", "мифология",
    "контекст", "подтекст", "сатира", "пародия", "клише", "канон", "антигерой", "мораль", "мотив",
    "реплика", "монтаж", "кадр", "эпизод", "критик", "рейтинг", "номинация", "экранизация", "адаптация", "оригинал",
    "Оскар", "Дисней", "Пиксар", "Кристофер Нолан", "Квентин Тарантино", "Стэн Ли",
    "Саурон", "Гэндальф", "Нео", "Морфеус", "Терминатор", "Рокки", "Индиана Джонс", "Хан Соло",
    "Дарк Соулс", "Элден Ринг", "Дум", "Half-Life"
  ],
  7: [
    'первое свидание',
    'секретный пароль',
